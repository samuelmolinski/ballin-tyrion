...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'mainsub-nav' => __( 'The Main Sub Menu', 'bonestheme' ),   // main nav in header
...
// the main sub menu
function bones_main_sub_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => 'menusub clearfix',           // class of container (should you choose to use it)
    	'menu' => 'The Sub Menu',                      // nav name
    	'menu_class' => 'nav top-nav clearfix',         // adding custom nav class
    	'theme_location' => 'mainsub-nav',                 // where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
