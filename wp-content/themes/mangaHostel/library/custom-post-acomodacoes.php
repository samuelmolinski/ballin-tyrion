...
function cp_acomodacaos() { 
	// creating (registering) the custom type 
	register_post_type( 'cp_acomodacaos', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Acomodações', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Acomodação', 'bonestheme'), /* This is the individual type */
			'all_items' => __('Todos Acomodações', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Adicionar Novo', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Adicionar Novo Acomodação', 'bonestheme'), /* Add New Display Title */
			'edit' => __( 'Editar', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __('Editar Acomodação', 'bonestheme'), /* Edit Display Title */
			'new_item' => __('Tipo de Novo', 'bonestheme'), /* New Display Title */
			'view_item' => __('View Post Type', 'bonestheme'), /* View Display Title */
			'search_items' => __('Busca Acomodações', 'bonestheme'), /* Search Custom Type Title */ 
			...
			'rewrite'	=> array( 'slug' => 'acomodacaos', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'cp_acomodacaos', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type('category', 'cp_acomodacaos');
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'cp_acomodacaos');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'cp_acomodacaos');
	...
	*/
    ...
    register_taxonomy( 'cp_acomodacaos_cat', 
    	array('cp_acomodacaos'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => true,     /* if this is true, it acts like categories */             
    		'labels' => array(
    			'name' => __( 'Categorias de Acomodações', 'bonestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Categorias de Acomodações', 'bonestheme' ), /* single taxonomy name */
    			'search_items' =>  __( 'Bucsa Categoria de Acomodações', 'bonestheme' ), /* search title for taxomony */
    		...
    		'show_ui' => true,
    		'query_var' => true,
    		'rewrite' => array( 'slug' => 'acomodacaos-categorias' ),
    	)
    );   
    
	// now let's add custom tags (these act like categories)
    register_taxonomy( 'cp_acomodacaos_tag', 
    	array('cp_acomodacaos'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => false,    /* if this is false, it acts like tags */                
    		'labels' => array(
    			'name' => __( 'Tag de Acomodações', 'bonestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Tag de Acomodações', 'bonestheme' ), /* single taxonomy name */
