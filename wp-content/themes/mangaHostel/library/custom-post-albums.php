...
function cp_albums() { 
	...
	register_post_type( 'cp_albums', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Ablums', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Ablums', 'bonestheme'), /* This is the individual type */
			'all_items' => __('Todos Ablums', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Adicionar Novo', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Adicionar Novo Ablum', 'bonestheme'), /* Add New Display Title */
			...
			'rewrite'	=> array( 'slug' => 'ablums', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'cp_albums', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type('category', 'cp_albums');
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'cp_albums');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'cp_albums');
	...
	*/
    ...
    register_taxonomy( 'cp_albums_cat', 
    	array('cp_albums'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => true,     /* if this is true, it acts like categories */             
    		'labels' => array(
    			'name' => __( 'Categorias de Ablums', 'bonestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Categorias de Ablums', 'bonestheme' ), /* single taxonomy name */
    			'search_items' =>  __( 'Bucsa Categoria de Ablums', 'bonestheme' ), /* search title for taxomony */
    ...
    register_taxonomy( 'cp_albums_tag', 
    	array('cp_albums'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => false,    /* if this is false, it acts like tags */                
    		'labels' => array(
    			'name' => __( 'Tag de Ablums', 'bonestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Tag de Ablums', 'bonestheme' ), /* single taxonomy name */
