...
function cp_eventos() { 
	...
	register_post_type( 'cp_eventos', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Eventos', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Evento', 'bonestheme'), /* This is the individual type */
			'all_items' => __('Todos Eventos', 'bonestheme'), /* the all items menu item */
			'add_new' => __('Adicionar Novo', 'bonestheme'), /* The add new menu item */
			'add_new_item' => __('Adicionar Novo Eventos', 'bonestheme'), /* Add New Display Title */
			'edit' => __( 'Editar', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __('Editar Evento', 'bonestheme'), /* Edit Display Title */
			'new_item' => __('Tipo de Novo', 'bonestheme'), /* New Display Title */
			'view_item' => __('View Evento', 'bonestheme'), /* View Display Title */
			'search_items' => __('Busca Evento', 'bonestheme'), /* Search Custom Type Title */ 
			...
			'has_archive' => 'cp_eventos', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type('category', 'cp_eventos');
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type('post_tag', 'cp_eventos');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'cp_eventos');
	...
	*/
    ...
    register_taxonomy( 'cp_eventos_cat', 
    	array('cp_eventos'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => true,     /* if this is true, it acts like categories */             
    		...
    		'show_ui' => true,
    		'query_var' => true,
    		'rewrite' => array( 'slug' => 'eventos-categorias' ),
    	)
    );   
    
	// now let's add custom tags (these act like categories)
    register_taxonomy( 'cp_eventos_tag', 
    	array('cp_eventos'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
